...
(1) How many inputs are used to splitting the tree at each node?
```{r}
who.rf$mtry
```

(2) Evaluate the prediction performance through the testing set. 
Draw the ROC curve:
```{r}
...
(3) Draw a variable importance plot.
```{r}
